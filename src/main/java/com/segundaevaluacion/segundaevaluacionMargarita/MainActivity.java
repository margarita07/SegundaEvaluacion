...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(getResources().getConfiguration().orientation == Configuration.ORIENTATION_LANDSCAPE){
            ...
            lstNumeros.add((Button) findViewById(R.id.parentesisabierto));
            lstNumeros.add((Button) findViewById(R.id.parentesicerra));
            lstNumeros.add((Button) findViewById(R.id.punto));
        }
        ...
        lstOperaciones.add((Button) findViewById(R.id.btnMULTIPLICACION));
        lstOperaciones.add((Button) findViewById(R.id.btnDIVISION));
    ...
    private void eliminarUltimo() {
        ...
        String str = lblEntrada.getText().toString();//obtengo el texto del TextView
